...
namespace Bloggie.Web.Controllers
{
    public class AdminBlogPostsController : Controller
    {
        ...
        public async Task<IActionResult> Add(AddBlogPostRequest addBlogPostRequest)
        {
            ...
            foreach(var seleectedTagId in addBlogPostRequest.SelectedTags)
            {
                var selectedTagIdAsGuid = Guid.Parse(seleectedTagId);
                var exsitingTag = await tagRepository.GetAsync(selectedTagIdAsGuid);
                if(exsitingTag != null) {
